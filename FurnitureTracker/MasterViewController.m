...
- (IBAction)addButton:(id)sender {
    UIAlertController* alert = [UIAlertController alertControllerWithTitle:@"Add Room" message:@"Do you want to add a room?" preferredStyle:UIAlertControllerStyleAlert];
